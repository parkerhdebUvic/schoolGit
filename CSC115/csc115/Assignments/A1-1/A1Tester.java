...
public class A1Tester {
	...
	public static void testGreatestCommonDenominator() {
		...
		System.out.println("Testing greatestCommonDenominator");
		...
		result = A1Exercises.greatestCommonDenominator(6, 3);
		expected = 3;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		result = A1Exercises.greatestCommonDenominator(12, 16);
		expected = 4;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		result = A1Exercises.greatestCommonDenominator(24, 16);
		expected = 8;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
	...
	public static void testCountMatches() {
		...
		int expected = 0;
		int[] arr1 = {2, 3, 2, 0};
		int[] arr2 = {2,2,2,2,2,5,6,2,3,4,5};
		int[] arr3 = {5,4,6,1,9,5,0};
		// add more arrays
		...
		System.out.println("Testing countMatches(arr2, 2)");
		result = A1Exercises.countMatches(arr2, 2);
		expected = 6;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing countMatches(arr3, 5)");
		result = A1Exercises.countMatches(arr3, 5);
		expected = 2;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
	}  
