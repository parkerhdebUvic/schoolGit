...
public class Lab3Tester { 
	...
	public static void main(String[] args) {
		...
		// Additional practice (not required for lab 2 completion)
		testRemoveFront();
	...
	public static void testShapeList() {
		...
		l.add(r00);
		System.out.println("call to size should be 1" + l.size());
	...
	public static void testRemoveFront() {
		...
		displayResults(l.size() == 4, "size is 4 before removals");
		resultString = l.toString();
		expectedString = r00.toString() + "\n" + c25.toString() + "\n"
					 + r45.toString() + "\n" + r76.toString() + "\n";
		displayResults(resultString.equals(expectedString), "toString before removals");
